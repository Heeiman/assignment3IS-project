...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println(kr.findCustomer("1").getName() + " " + kr.findCustomer("1").getcAdress() + " "
				+ kr.findCustomer("1").getcNumber());
		...
		System.out.println(kr.findCustomer("1").getName() + " " + kr.findCustomer("1").getcAdress() + " "
				+ kr.findCustomer("1").getcNumber());
		System.out.println(kr.findCustomer("2").getName() + " " + kr.findCustomer("2").getcAdress() + " "
				+ kr.findCustomer("2").getcNumber());
		...
		p1.addItem(item);
		p1.addOrdRowP(test);
		System.out.println(p1.getName() + " " + p1.getCategory() + " " + p1.getPrice() + " " + item.getSerNumber() + " "
				+ row.getNumber() + " " + row.getAmount());
